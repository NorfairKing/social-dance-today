...
, containers, criterion, deepseq, esqueleto, filepath, genvalidity
...
, genvalidity-time, genvalidity-typed-uuid, http-client, ical, lib
, microlens, monad-logger, mtl, password, path, path-io
, path-pieces, persistent, persistent-sqlite, pretty-show
...
mkDerivation {
  ...
  testHaskellDepends = [
    aeson aeson-pretty base bytestring cache containers esqueleto
    genvalidity genvalidity-sydtest genvalidity-sydtest-aeson
    genvalidity-sydtest-persistent genvalidity-text genvalidity-time
    http-client ical monad-logger mtl password path path-io path-pieces
    ...
    uuid yesod yesod-auth yesod-core
  ];
