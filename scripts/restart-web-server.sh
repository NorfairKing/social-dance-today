...
export SALSA_PARTY_WEB_SERVER_SALSA_BERLIN_DE_IMPORTER_ENABLED=True
export SALSA_PARTY_WEB_SERVER_SALSA_BERLIN_DE_IMPORTER_PERIOD=60
export SALSA_PARTY_WEB_SERVER_SALSA_BERLIN_DE_IMPORTER_PHASE=0
