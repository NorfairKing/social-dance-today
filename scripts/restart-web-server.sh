...
export SALSA_PARTY_WEB_SERVER_GOLATINDANCE_COM_IMPORTER_PERIOD=60
...
export SALSA_PARTY_WEB_SERVER_DANCEPLACE_COM_IMPORTER_PERIOD=60

# export SALSA_PARTY_WEB_SERVER_SENTRY_DSN="XXX"
export SALSA_PARTY_WEB_SERVER_SENTRY_RELEASE=manual

export SALSA_PARTY_WEB_SERVER_GOOGLE_API_KEY="AIzaSyDi9IUTRr2bmc5KPUsHJ-3TVdxPeAdoySg"
