...
export SALSA_PARTY_WEB_SERVER_SALSAON2HAPPENINGS_CH_IMPORTER_ENABLED=True
export SALSA_PARTY_WEB_SERVER_SALSAON2HAPPENINGS_CH_IMPORTER_PHASE=0
export SALSA_PARTY_WEB_SERVER_SALSAON2HAPPENINGS_CH_IMPORTER_PERIOD=10
