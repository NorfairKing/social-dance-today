...
export SALSA_PARTY_WEB_SERVER_SALSA_FAURAX_FR_IMPORTER_ENABLED=False
export SALSA_PARTY_WEB_SERVER_SALSA_FAURAX_FR_IMPORTER_PHASE=0
export SALSA_PARTY_WEB_SERVER_SALSA_FAURAX_FR_IMPORTER_PERIOD=10
