...
export SALSA_PARTY_WEB_SERVER_SCHEDULE_REMINDER_ENABLED=False
export SALSA_PARTY_WEB_SERVER_SCHEDULE_REMINDER_PHASE=0
export SALSA_PARTY_WEB_SERVER_SCHEDULE_REMINDER_PERIOD=10
...
export SALSA_PARTY_WEB_SERVER_IMPORTERS_ENABLED=False
export SALSA_PARTY_WEB_SERVER_IMPORTERS_PHASE=0
export SALSA_PARTY_WEB_SERVER_IMPORTERS_PERIOD=10
...
export SALSA_PARTY_WEB_SERVER_LONDONSALSA_CO_UK_IMPORTER_ENABLED=False
export SALSA_PARTY_WEB_SERVER_WHERECANWEDANCE_COM_IMPORTER_ENABLED=False
