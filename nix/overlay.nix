...

{
  ...
  salsaPartyReleasePackages = mapAttrs (_: pkg: justStaticExecutables pkg) final.haskellPackages.salsaPartyPackages;
        ...
        let
          salsaPartyPackages =
              ...
              salsaPartyPkg =
                ...
                overrideCabal (self.callPackage (../${name}) { })
                  (old: {
                    ...
                    doHaddock = false;
                    doCoverage = false;
                    doCheck = false; # Only on for the coverage report
            ...
            in
            {
              ...
              salsa-party-web-server = overrideCabal
                (withRemoteStaticResources (salsaPartyPkg "salsa-party-web-server") {
          ...
          # Until amazonka 2 is out and in nixpkgs:
