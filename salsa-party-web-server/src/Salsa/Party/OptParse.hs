...
combineToSettings Flags {..} Environment {..} mConf = do
  ...
  let settingScheduleReminderLooperSettings = deriveLooperSettings (seconds 45) (hours 24) flagScheduleReminderLooperFlags envScheduleReminderLooperEnvironment (mc confScheduleReminderLooperConfiguration)
