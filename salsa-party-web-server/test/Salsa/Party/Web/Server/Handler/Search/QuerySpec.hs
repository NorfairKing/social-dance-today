                    ...
                    $ \externalEvent3Prototype ->
                      forAllValid $ \day ->
                        flip runSqlPool pool $ do
                          ...
                          let party1 = party1Prototype {partyTitle = "Party 1", partyDay = day, partyPlace = place1Id}
                          party1Id <- DB.insert party1
                          let party2 = party2Prototype {partyTitle = "Party 2", partyDay = day2, partyPlace = place2Id}
                          DB.insert_ party2
                          let party3 = party3Prototype {partyTitle = "Party 3", partyDay = day2, partyPlace = place3Id}
                          DB.insert_ party3
                          ...
                          let place6 = Place {placeQuery = "Place 6", placeLat = 0.2, placeLon = 0.2}
                          place6Id <- DB.insert place6
                          let externalEvent1 = externalEvent1Prototype {externalEventTitle = "External Event 1", externalEventDay = day, externalEventPlace = place4Id}
                          externalEvent1Id <- DB.insert externalEvent1
                          let externalEvent2 = externalEvent2Prototype {externalEventTitle = "External Event 2", externalEventDay = day, externalEventPlace = place5Id}
